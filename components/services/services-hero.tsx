  ...
  return (
    <div ref={containerRef} className="relative h-screen overflow-hidden">
      <motion.div style={{ y, opacity }} className="absolute inset-0 z-0">
        <Image
          src="/images/services/servicesherobg.jpg"
      ...
      <div className="relative z-10 h-full flex flex-col justify-center items-center text-center px-6 pt-24">
        ...
        >
          ...
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-bold leading-tight tracking-tight text-zinc-100 mb-6">
            Transforming <span className="text-zinc-400">moments</span> into timeless{" "}
            <span className="text-zinc-400">memories</span>
          </h1>
          <p className="text-lg md:text-xl text-zinc-400 max-w-2xl mx-auto">
            Discover our comprehensive range of photography services designed to capture your vision with precision and
            artistry.
          </p>
        </motion.div>
